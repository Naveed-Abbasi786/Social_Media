...
export default function Header() {
  return (
    <div>
      ...
      <div className="w-full relative h-[50vh]">
        ...
        />
        <div className="absolute top-4 right-4 bg-white text-[#2f65b9] hover:bg-[#2f65b9] hover:text-white cursor-pointer ease-linear duration-100 rounded-lg text-[14px] p-2">
  ...
  <div className="w-[96%] mx-auto mb-6 bg-white rounded-lg shadow-lg grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 items-center gap-4">
    {/* Left Section */}
    <div className="p-8">
      <div className="flex flex-wrap justify-center gap-4">
        <div className="flex items-center">
          <img src={Coin} alt="Coin Icon" className="w-6 h-6 mr-2" />
          <h3 className="text-[17px] font-semibold leading-[28px] text-[#07142e]">
            8420 Coins
          </h3>
        </div>
        <div className="flex items-center">
    ...
    <div className="flex justify-center items-center  -mt-40">
      <div className="flex flex-col items-center text-center">
        ...
        <h2 className="text-xl font-semibold text-gray-800 mt-4">Marvin McKinney</h2>
