    ...
    <div className=" w-min-[20px]">
      ...
      >
        <div
          ...
          className={`absolute -right-[17px] z-0 top-[120px] rounded-md h-8 w-10 text-center flex justify-center items-center shadow-sm  ${
            isDarkMode ? "bg-[#080D1E]" : "bg-white"
          } transform rotate-[310deg] cursor-pointer text-white`}
        >
        ...
        {/* Drawer */}
        <div
          className={`h-[100vh] shadow-lg z-10 ${
            isDarkMode ? "bg-[#080D1E]" : "bg-white"
        ...
        >
          ...
          {isOpen ? (
            <>
              ...
              <div
                onClick={() => navigate("/")}
                className="flex -mt-1  items-center gap-3 pb-2"
              >
                <img
                  src={Logo}
                  alt="Logo"
                ...
                <h1
                  ...
                  } cursor-pointer text-[28px] font-sans font-semibold`}
                >
                  SocialV
                </h1>
              </div>
              <hr
                className={`${
                  isDarkMode ? "border-[#101421]" : "border-[F1F1F1]"
                }  border-t-1  w-[17.5vw] overflow-hidden -ml-4 -mt-[17px]`}
              />

              {/* Profile Image and Name */}
              <div
                onClick={() => navigate("/profile")}
                className={`flex cursor-pointer items-center border-b ${
                  isDarkMode ? "border-[#101421]" : "border-[F1F1F1]"
                }   pb-6 mt-2 space-x-3`}
              >
                <img
            ...
            <>
              <div className="w-full  flex flex-col  items-center space-y-4">
                ...
                <div
                  className={`w-full p-6 flex flex-col justify-between items-center !mt-20  ${
                    isDarkMode ? "bg-[#080D1]" : "bg-[#F8F9FA] "
                  } rounded-md gap-6`}
                >
