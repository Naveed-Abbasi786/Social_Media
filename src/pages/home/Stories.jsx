...
export default function Stories() {
  ...
  return (
    <div className="relative w-[100%] -z-0  p-6">
          ...
          >
            <div className="" onClick={() => openModal(story)}>
              ...
              <div className=" flex   justify-center items-center">
                ...
                />
                <span
                  className={`text-sm font-medium mt-5 text-center ${
      ...
      <ReactModal
        ...
        overlayClassName="fixed inset-0 bg-black bg-opacity-80 flex justify-center p-8 items-center z-50"
        className={` ${
          isDarkMode ? "bg-[#080D1E]" : "bg-white"
        } rounded-lg w-full max-w-lg  outline-none  relative`}
      >
        {/* Linear Loading Bar */}
        <div
          className={`absolute top-[70px] left-0 w-[100%] h-1  ${
            isDarkMode ? "bg-[#080D1E]" : "bg-gray-300"
          }`}
        >
          <div
  ...
  <img
    ...
    className="w-12 h-12 object-cover rounded-full border p-1"
  />
  <div className="flex flex-col">
    <span className="text-lg font-medium text-[#6f7f92]">
      {currentStory.name}
    </span>
    <span className="text-sm text-[#6f7f92]">1 Minute ago</span>
  </div>
</div>
